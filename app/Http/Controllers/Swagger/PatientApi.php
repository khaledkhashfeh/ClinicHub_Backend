    ...
    #[OA\Post(
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    properties: [
                        new OA\Property(property: "first_name", type: "string", maxLength: 255, example: "Ahmad", description: "First name (required)"),
                        new OA\Property(property: "last_name", type: "string", maxLength: 255, example: "Ali", description: "Last name (required)"),
                        new OA\Property(property: "governorate_id", type: "integer", minimum: 1, example: 1, description: "Governorate ID (must exist in governorates table)"),
                        new OA\Property(property: "district_id", type: "integer", minimum: 1, example: 1, description: "District ID (must exist in cities table)"),
                        new OA\Property(property: "gender", type: "string", enum: ["male", "female"], example: "male", description: "Gender (required)"),
                        new OA\Property(property: "date_of_birth", type: "string", format: "date", example: "1990-01-01", description: "Date of birth (required, before today)"),
                        new OA\Property(property: "image", type: "string", format: "binary", description: "Profile image (optional, jpeg/png/jpg/webp, max 2MB)"),
                    ],
                    required: ["first_name", "last_name", "governorate_id", "district_id", "gender", "date_of_birth"]
                )
            )
        ),
        responses: [
            ...
            new OA\Response(
                response: 401,
                description: "Unauthorized - must verify phone first"
            ),
            new OA\Response(
                response: 403,
