...
class SecretaryApi
{
    ...
    #[OA\Post(
        path: "/api/secretaries/updateAccounte",
        summary: "Update secretary account",
        description: "Updates an existing secretary account information",
        tags: ["Secretary Management"],
        security: [["jwt" => []]],
        requestBody: new OA\RequestBody(
            required: true,
            content: new OA\MediaType(
                ...
                schema: new OA\Schema(
                    properties: [
                        ...
                        new OA\Property(property: "phone_number", type: "string", example: "0912345678", description: "Phone number in Syrian format (optional)"),
                        new OA\Property(property: "email", type: "string", format: "email", example: "ahmad.secretary@example.com", description: "Email address (optional)"),
                        ...
                        new OA\Property(property: "password", type: "string", format: "password", example: "password123", description: "New password (optional)"),
                        new OA\Property(property: "password_confirmation", type: "string", format: "password", example: "password123", description: "Password confirmation (required if password is provided)"),
        ...
        responses: [
            new OA\Response(
                response: 200,
                description: "Secretary account updated successfully",
                content: new OA\JsonContent(
                    properties: [
                        new OA\Property(property: "success", type: "boolean", example: true),
                        new OA\Property(property: "message", type: "string", example: "secretary account has been updated successfully"),
                        new OA\Property(
                            property: "data",
                            properties: [
                                new OA\Property(
